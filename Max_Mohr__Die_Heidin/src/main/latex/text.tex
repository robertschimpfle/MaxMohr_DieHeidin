...
\addchap{Erster Teil}
\include{1_1._kapitel}
\include{1_2._kapitel}
\include{1_3._kapitel}

\addchap{Zweiter Teil}
\include{2_1._kapitel}
\include{2_2._kapitel}
\include{2_3._kapitel}

\addchap{Dritter Teil}
\include{3_1._kapitel}
\include{3_2._kapitel}
\include{3_3._kapitel}
